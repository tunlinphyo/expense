import { yearMonthStyle } from "./styles"

export class YearMonth extends HTMLElement {
    ...
    private populatePicker(id: string, items: (string | number)[]) {
        ...
        scrollEl.classList.add('picker-scroll')
...
customElements.define('year-month', YearMonth)